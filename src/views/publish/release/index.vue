          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="scope">
              <el-button 
                size="mini"
                type="primary" 
                @click="showDetail(scope.row)">去发布
              </el-button>
              <el-button
                size="mini"
                type="success"
                @click="handleDelete(scope.row)">取消发布
              </el-button>
            </template>
          </el-table-column>
        </el-table>
...
export default {
  ...
  methods: {
    ...
    showDetail(row) {
      ...
      this.$router.replace({path: '/release', query: {project_name: row.project_name, version: row.version, id: row.id }})
